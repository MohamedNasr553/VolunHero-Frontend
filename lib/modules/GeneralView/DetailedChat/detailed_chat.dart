...
class _DetailedChatsState extends State<DetailedChats> {
  ...
  void _onLongPress(int index) {
    setState(() {
      ...
      UserLoginCubit.get(context).messageToDelete =
          UserLoginCubit.get(context).selectedChat!.messages[index].id;
      _showIcon = true;
    });
  }
    ...
    return BlocConsumer<UserLoginCubit, UserLoginStates>(
      ...
      if (state is CreateMessageSuccessState) {
        UserLoginCubit.get(context)
            .refreshChatPage(UserLoginCubit.get(context).selectedChat!.id);
      }
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          UserLoginCubit.get(context).refreshChatPage(
                              UserLoginCubit.get(context).selectedChat!.id);
                        },
              ...
              child: Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: const BorderRadius.only(
                      ...
                      bottomRight:
                          Radius.zero, // No radius for bottom right corner
                    ),
                  ),
                  child: Padding(
                      ...
                      child: (state is! GetLoggedInUserChatsLoadingState)
                          ? SmoothListView.separated(
                              ...
                              itemCount: UserLoginCubit.get(context)
                                  .selectedChat!
                                  .messages
                                  .length,
  ...
  Widget buildMessageItem(int index, BuildContext context) {
    double screenWidth = MediaQuery.of(context).size.width;
    DateTime? createdAt =
        UserLoginCubit.get(context).selectedChat!.messages[index].createdAt;
    String? durationText;
    ...
    return (UserLoginCubit.get(context)
                .selectedChat!
                .messages[index]
                .isDeleted ==
            false)
        ? (UserLoginCubit.get(context).selectedChat!.messages[index].senderId !=
                UserLoginCubit.get(context).loggedInUser!.id)
            ? Row(
              ...
              child: IconButton(
                ...
                onPressed: () async {
                  ...
                  if (text.trimLeft().trimRight().isNotEmpty) {
                    await UserLoginCubit.get(context)
                        .sendMessage(
                            chatId: chatId,
                            senderId: senderId,
                            text: text,
